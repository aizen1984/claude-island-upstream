...
> 从 SKILL.md 提取的通用设计原则和参考资料。创建/修改 Skill 时按需加载。
...
A skill should only contain essential files. Do NOT create: README.md, INSTALLATION_GUIDE.md, QUICK_REFERENCE.md, CHANGELOG.md, etc.
...
Organize by domain to avoid loading irrelevant context. When a user asks about sales metrics, Claude only reads sales.md.
